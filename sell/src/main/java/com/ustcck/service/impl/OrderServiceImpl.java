...
import com.ustcck.converter.OrderMaster2OrderDTOConverter;
...
import com.ustcck.repository.OrderDetailRepository;
import com.ustcck.repository.OrderMasterRepository;
import com.ustcck.service.OrderService;
import com.ustcck.service.ProductService;
import com.ustcck.utils.KeyUtils;
...
/**
 * Created by CaoKai on 2018/3/29 19:21.
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        for (OrderDetail orderDetail : orderDTO.getOrderDetailList()) {
            ProductInfo productInfo = productService.findById(orderDetail.getProductId()).orElseThrow(() -> new SellException(ResultEnum.PRODUCT_NOT_EXIST));
